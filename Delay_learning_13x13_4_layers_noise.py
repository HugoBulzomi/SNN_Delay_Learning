...
sim, options = get_simulator(("--plot-figure", "Plot the simulation results to a file", {"action": "store_true"}),
                             ...
                             ("--lambdad", "Homeostasis application rate for delays", {"default": 0.001}),
                             ("--lambdaw", "Homeostasis application rate for weights", {"default": 0.000001}),
                             ("--STDPA", "STDP increment/decrement range for weights", {"default": 0.001}))
